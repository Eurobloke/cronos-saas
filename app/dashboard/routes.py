...
BOTS_REGISTRY = {
    ...
    'music_video': {
        'slug': 'music_video',
        'icon': '🎵',
        'name': 'Music Video Bot',
        'dir': Path(r'C:\Users\franc\music\music_video_bot'),
        'credit_cost': 15,
        'service_slug': 'music_video_completo',
        'chrome_port': 9226,
        'has_voz': False,
        'default_hashtags': '#MusicVideo #Corridos #Musica #Videos #Trending',
    },
    'vehiculos': {
        'slug': 'vehiculos',
        'icon': '🚗',
        'name': 'Vehículos Bot',
        'dir': Path(r'C:\Users\franc\music\vehiculos_bot'),
        'credit_cost': 10,
        'service_slug': 'vehiculos_completo',
        'chrome_port': 9233,
        'has_voz': True,
        'default_hashtags': '#Carros #Vehiculos #Autos #MotorShow #Cars',
    },
    'distrokid': {
        'slug': 'distrokid',
        'icon': '💿',
        'name': 'DistroKid Bot',
        'dir': Path(r'C:\Users\franc\music\proyecto_album_videos\distrokid_bot'),
        'credit_cost': 20,
        'service_slug': 'distrokid_completo',
        'chrome_port': 9234,
        'has_voz': False,
        'default_hashtags': '#DistroKid #Album #MusicRelease #NewMusic',
    },
}
